...
const Carousel = () => {
  ...
  return (
    <div className='text-center'>
      ...
      <div className="max-w-[800px] h-[360px] w-full m-auto py-16 px-4 relative">
        <div  style={{backgroundImage: `url($(slides[currentIndex].url))`}} className="w-full rounded bg-center bg-cover duration-500"></div>
